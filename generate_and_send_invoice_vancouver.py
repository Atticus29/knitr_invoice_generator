...
def main(year: int = None, month: int = None):
    ...
    csv_name = f"sbg_vancouver_invoice_{invoice_date.day}_{month_name}_{invoice_date.year}.csv"
    pdf_name = f"sbg_vancouver_invoice_{invoice_date.day}_{month_name}_{invoice_date.year}.pdf"
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python generate_and_send_invoice_vancouver.py                    # Current month
  python generate_and_send_invoice_vancouver.py -m 10              # October of current year
  python generate_and_send_invoice_vancouver.py -m 10 -y 2024      # October 2024
  python generate_and_send_invoice_vancouver.py --month 12 --year 2023  # December 2023
        """
    )
